...
def _validated_scale(name: str, value: float | None) -> float:
...
def sgl_native_q8kv8_sparse_decode(
    ...
    sm_scale = _validated_scale("sm_scale", sm_scale)
    q_scale = _validated_scale("q_scale", q_scale)
    k_scale = _validated_scale("k_scale", k_scale)
    v_scale = _validated_scale("v_scale", v_scale)
