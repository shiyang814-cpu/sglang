...
class MiniMaxSparseAttnBackend(AttentionBackend):
    def __init__(self, runner: ModelRunner):
        ...
        logger.info(
            ...
            f"prefill_main_attn={'sgl_native_q8kv8' if self.use_sgl_native_q8kv8 else ('MSA' if self.use_msa else 'triton')}, "
            f"decode_main_attn={'native_q8kv8_decode' if self.use_sgl_native_q8kv8_decode else ('MSA' if self.use_msa else 'triton')}, "
